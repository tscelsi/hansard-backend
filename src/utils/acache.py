...
def cached(
    ...
    """Decorator to wrap a function or a coroutine with a memoizing callable that saves
    results in a cache.
...
def cachedmethod(
    ...
    """Decorator to wrap a class or instance method with a memoizing callable that saves
    results in a cache.
